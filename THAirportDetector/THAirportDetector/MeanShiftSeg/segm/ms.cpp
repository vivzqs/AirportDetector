...
void MeanShift::ErrorHandler(char *className, char *methodName, char* errmsg)
{
	...
	strcpy_s(ErrorMessage, 256, className);
	strcat_s(ErrorMessage,256, "::");
	strcat_s(ErrorMessage,256, methodName);
	strcat_s(ErrorMessage,256, " Error: ");
	
	//store message into error message
	strcat_s(ErrorMessage,256, errmsg);
