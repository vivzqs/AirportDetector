...
public:
	...
	msImageProcessor( bool bWaitBar );        //Default Constructor
	...
	BOOL DefineImage(FILE*& fp, byte*,imageType, int, int,bool bAllowCache = true,bool *bHaveSave = false);
	BOOL DefineBgImage(byte*, imageType , int , int );
	...
	//沈占锋增加2009.11.20
	int GetRegions(int**, unsigned char**, int**);
...
public:
	...
	void    SetRange(int begin, int end){m_wait_begin = begin; m_wait_end = end;}

	////////////////////////////////////////////////////////////////////////////
	//沈占锋增加 2009.11.23
	void SaveLUVImage(FILE* fp);
	void SetClassStateOutputDefined(bool bSet){class_state.OUTPUT_DEFINED = bSet;};
};
